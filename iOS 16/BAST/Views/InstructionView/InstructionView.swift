    ...
    var body: some View {
        ScrollView
        {
            VStack
            {
                ...
                InstructionEntrieView(step: "8", text: Text("Import \"log-aggregated\" into the App using the Import Button on the left top site."), systemImage: "square.and.arrow.down", backgroundColor: .green, iconColor: .white)
